...
const AuthScreen = () => {
    ...
    const handleFormSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('/api/v1/auth/signup', { email, password, username });
            ...
            setMessage('Signup Failed: ' + (error.response ? error.response.data.message : error.message));
